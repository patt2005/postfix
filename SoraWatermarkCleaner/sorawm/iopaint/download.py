...
from SoraWatermarkCleaner.sorawm.iopaint.model.original_sd_configs import get_config_files
from SoraWatermarkCleaner.sorawm.iopaint.schema import ModelInfo, ModelType


def cli_download_model(model: str):
    from SoraWatermarkCleaner.sorawm.iopaint.model import models
    from SoraWatermarkCleaner.sorawm.iopaint.model.utils import handle_from_pretrained_exceptions
